...
public class Author extends javax.swing.JFrame {
    ...
    public void author_load() throws SQLException
    {
        int c;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{ pst = con.prepareStatement("insert into author(name)values(?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int id = Integer.parseInt(d1.getValueAt(selectIndex,0).toString());
        String name = txtname.getText();
       try{ pst = con.prepareStatement("update  author set name=? where id=?");
        pst.setString(1, name);
        pst.setInt(2, id);
        int k = pst.executeUpdate();
        if(k==1)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int selectIndex = jTable1.getSelectedRow();
        int id = Integer.parseInt(d1.getValueAt(selectIndex,0).toString());
        try{pst = con.prepareStatement("delete from author where id=?");
        pst.setInt(1, id);
        int k = pst.executeUpdate();
        if(k==1)
        {
