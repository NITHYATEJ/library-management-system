...
public class Book extends javax.swing.JFrame {
    ...
    {
        int c;
        pst = con.prepareStatement("select b.id,b.bname,c.catname,a.name,p.name from book b JOIN category c On b.category=c.id JOIN author a on b.author=a.id Join publisher p On b.publisher=p.id");
        rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Book Name", "Category", "Author", "Publisher"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{ pst = con.prepareStatement("insert into book(bname,category,author,publisher)values(?,?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{pst = con.prepareStatement("update  book set bname=?,category=?,author=?,publisher=? where id=?");
